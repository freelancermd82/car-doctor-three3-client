    ...
    return (
        <div className="carousel w-full h-[600px]">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute flex items-center rounded-xl h-full w-full bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
                    <div className='w-1/2 ml-5 text-white space-y-5'>
